  ...
  return (
    <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
      <div class="my-auto">
        ...
        <ul class="fa-ul mb-4">
          <li>
            <i class="fa-li fa fa-check"></i> Manjaro i3wm Community Edition
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Highly customized VS Code with
            self crafted theme{' '}
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Bash, Oh My Zsh
          </li>
        </ul>
        ...
        <div class="fa-ul mb-0">
          <li>
            <i class="fa-li fa fa-check"></i> Redux
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Dartlang
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> MongoDB
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Java
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> PHP
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> C++
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> SQL
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> MySQL
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> PostgreSQL
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Git
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Linux
          </li>
          <li>
            <i class="fa-li fa fa-check"></i> Java Server Pages
          </li>
        </div>
      </div>
    </section>
